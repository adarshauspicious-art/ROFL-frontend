      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8">
        ...
        >
          <div className="w-full max-w-md  rounded-3xl p-10">
            ...
            <button
              disabled={loading}
              className="mt-4 w-full text-white bg-[#F2482D] hover:bg-[#d33c25] py-3 rounded-xl border border-zinc-500/40 transition font-semibold flex items-center justify-center gap-2 "
              type="submit"
              onClick={()=>router.push("/web/auths/forget-password/verify")}
            >
