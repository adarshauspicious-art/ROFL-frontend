        ...
        <div className="w-full">
          ...
          <section className="grid grid-cols-2 gap-6 mt-5 max-w-9xl mx-auto">
            ...
            <div className="bg-[#F2482D] rounded-2xl overflow-hidden shadow-lg w-full max-w-3xl flex flex-col min-h-[220px]">
              ...
              <div className="flex justify-between px-5 pt-4 pb-5 text-white mt-auto">
                <div>
                  <p className="text-lg opacity-70 mb-0.5">Shipping Status</p>
                  <p className="text-2xl font-semibold">Shipped</p>
                </div>
                <div className="text-right">
                  <p className="text-lg opacity-70 mb-0.5">
                    Tracking Link / ID
                  </p>
                  <p className="text-2xl font-semibold">756 004 4001</p>
                </div>
              </div>
            </div>
            {/* Payouts */}
              ...
              <div className="bg-white rounded-xl shadow p-6 text-gray-900">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center border border-gray-200 rounded-xl px-5 py-4 bg-gray-50">
                    ...
                    <button
                      disabled
                      className="flex items-center gap-2 bg-green-100 text-green-600 px-4 py-1.5 rounded-lg border border-green-200 cursor-not-allowed text-sm font-medium"
                    >
                      Received
                    </button>
                  </div>
