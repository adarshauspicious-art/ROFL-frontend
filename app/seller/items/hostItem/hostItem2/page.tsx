              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-y-8 gap-x-12 text-2xl">
                    {/*  Total Spots */}
                    <div>
                      <p className="text-2xl text-gray-600">Total Spots</p>
                    ...
                    {/*  Total Pot */}
                    <div>
                      <p className="text-2xl text-gray-600">Total Pot</p>
                    ...
                    {/*  Ticket Price */}
                    <div>
                      <p className="text-2xl text-gray-600">Ticket Price</p>
                      <p className="font-semibold text-xl text-gray-900">
                    ...
                    {/*  Platform Fee */}
                    <div>
                      <p className="text-2xl text-gray-600">Platform Fee</p>
                      <p className="font-semibold text-xl text-gray-900">
                    ...
                    {/*  IRS Withholding */}
                    <div>
                      <p className="text-2xl text-gray-600">IRS Withholding</p>
                      <p className="font-semibold text-xl text-gray-900">
                    ...
                    {/*  Processing Fee */}
                    <div>
                      <p className="text-2xl text-gray-600">Processing Fee</p>
                      <p className="font-semibold text-xl text-gray-900">
