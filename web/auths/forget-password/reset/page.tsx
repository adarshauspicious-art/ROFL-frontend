        ...
        >
          <div className="w-full max-w-md rounded-3xl p-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`mt-4 w-full text-white bg-[#F2482D] hover:bg-[#d33c25] py-3 rounded-xl border border-black transition font-semibold flex items-center justify-center gap-2  ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
              onClick={()=>router.push("/web/auths/forget-password/reset/pass-updated")}
            >
