...
export default function AccountCreated() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
            <div className="bg-black rounded-3xl shadow-lg max-w-md w-full p-8 text-center">

                {/* Icon */}
                <div className="flex justify-center mb-6">
                    <Image
                        src="/pass-updated.svg" // place image in /public
                ...
                <p className="text-gray-400 mt-5 mb-8">
                   Congratulations!! <br/> Your Password has been updated successfully!
                </p>
